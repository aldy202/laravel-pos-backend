                                ...
                                <div class="selectgroup selectgroup-pills">
                                    ...
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="0"
                                            {{ $product->status == 0 ? 'checked' : '' }} class="selectgroup-input">
                                ...
                                <div class="selectgroup selectgroup-pills">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="is_favorite" value="1"
                                            {{ $product->is_favorite == 1 ? 'checked' : '' }} class="selectgroup-input">
                                        <span class="selectgroup-button">Yes</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="is_favorite" value="0"
                                            {{ $product->is_favorite == 0 ? 'checked' : '' }} class="selectgroup-input">
